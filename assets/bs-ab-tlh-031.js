const addBannersTlh031 = (productInfos, matchingUrl) => {
    if(window.location.href.includes(matchingUrl)) {
        const slidesInner = document.querySelectorAll(".flickity-slider .Product__SlideItem .AspectRatio");  

        slidesInner.forEach((slideInner, index) => {
            if(index > 0 && productInfos[(index - 1)]){
                    ...
                    <div class="image-banner-popup">
                        <div class="image-banner-popup__info">
                            ...
                            <div class="image-banner-popup__info__popup">
                                <p>
                                    ${ productInfos[(index - 1)].description }
                                </p>
