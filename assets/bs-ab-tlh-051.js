window.activateAbTlh051 = () => {
	...
	const testimonialsSection = document.querySelector('[data-js-tlh-051]');
	const testimonialsWrapper = testimonialsSection.querySelector('[data-js-tlh-051-swiper-wrapper]');
	...
	const swiper = new Swiper('[data-js-tlh-051-swiper]', {
	...
	testimonialsSection.setAttribute('data-js-tlh-051', 'true');

	const reviewsButton = testimonialsSection.querySelector('[data-js-tlh-051-button]');
