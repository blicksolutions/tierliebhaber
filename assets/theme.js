                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (!this.isOpen) {
                                    ...
                                    return dataLayer.push({ event: "experiment:triggered", "exp.event.type": t + ":opened" }), !1;
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                this._updateProductPrices(t, e),
                                    ...
                                    this._updateShippingCostText(t),
                            ...
                            value: function (e) {
                                if (e) {
                                    if (!e.hasOwnProperty("unit_price") && document.querySelector("[data-reference-product]")) {
                                        ...
                                        e = t.variants.find(({ title: t }) => t === e.title);
                                    }
                                    var i = this.element.querySelector(".ProductMeta__UnitPriceMeasurement");
                                    if(!i) return;
                                    if (e.hasOwnProperty("unit_price")) {
                                        (i.style.display = "block"),
                                            (i.querySelector(".UnitPriceMeasurement__Price").innerHTML = r.default.formatMoney(e.unit_price, window.theme.moneyFormat)),
                                            (i.querySelector(".UnitPriceMeasurement__ReferenceUnit").textContent = e.unit_price_measurement.reference_unit);
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t = JSON.parse(document.querySelector("[data-product]").textContent),
                                    { hasFreeShipping: i } = t.variants.find(({ id: t }) => t === e.id),
                                        ...
                                        document.dispatchEvent(new CustomEvent("theme:loading:end")),
                                            e.ok
                                                ? (i.removeAttribute("disabled"),
                                                    ...
                                                    dataLayer.push({ event: "optimize:product:added" }))
                            ...
                            value: function (e) {
                                ...
                                return fetch(window.routes.cartUrl + "?view=" + (this.options.drawer && "cart" !== window.theme.pageType ? "drawer" : "ajax") + "&timestamp=" + Date.now(), { credentials: "same-origin", method: "GET" }).then(
                                    function (i) {
                                        ...
                                        dataLayer.push({ event: "experiment:triggered", "exp.event.type": "cart:updated", "exp.cart.itemCount": t.itemCount });
                                    }
                                );
                            },
                        },
