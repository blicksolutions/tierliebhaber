						...
						},
						{
							...
							value: function () {
								this.isOpen &&
									...
									s.default.matchesBreakpoint("lap-and-up") ? document.body.removeEventListener("click", this._clickOutsideListener) : this.showOverlay && (this.pageOverlayElement.classList.remove("is-visible"), this.pageOverlayElement.removeEventListener("click", this._closeListener)),
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function (e) {
								if (!this.isOpen) {
									this.element.dispatchEvent(new CustomEvent("search:close", { bubbles: !0 })), e && e.preventDefault(), this.element.setAttribute("aria-hidden", "false"), this._calculateMaxHeight(), document.documentElement.classList.add("no-scroll"), n.default.trapFocus(this.element, "drawer"), (document.querySelector("#shopify-section-header").style.zIndex = ""), this.pageOverlayElement.classList.add("is-visible"), this.pageOverlayElement.addEventListener("click", this._closeListener), (this.isOpen = !0), this.onOpen();
				...
				function e(t, i, n) {
					switch ((_classCallCheck(this, e), (this.element = t), (this.delegateElement = new domDelegate.Delegate(this.element)), (this.stackProductImages = i), (this.enableVideoLooping = n), (this.player = null), this.element.getAttribute("data-media-type"))) {
						case "video":
							...
							(s.rel = "stylesheet"), (s.href = "https://cdn.shopify.com/shopifycloud/shopify-plyr/v1.0/shopify-plyr.css"), document.head.appendChild(s), window.Shopify.loadFeatures([{ name: "video-ui", version: "1.0", onLoad: this._setupHtml5Video.bind(this) }]);
							break;
						case "external_video":
						...
						},
						{
							...
							value: function () {
								...
								document.dispatchEvent(new CustomEvent("theme:loading:start")),
									fetch(window.routes.cartUrl + "/shipping_rates.json?shipping_address[zip]=" + a + "&shipping_address[country]=" + t + "&shipping_address[province]=" + i, { credentials: "same-origin", method: "GET" }).then(function (t) {
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function (e) {
								var t = this;
								return fetch(window.routes.cartUrl + "?view=" + (this.options.drawer && "cart" !== window.theme.pageType ? "drawer" : "ajax") + "&timestamp=" + Date.now(), { credentials: "same-origin", method: "GET" }).then(function (i) {
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								...
								"" !== t &&
									fetch(window.routes.searchUrl + "?view=recently-viewed-products&type=product&q=" + t, {
										credentials: "same-origin",
										method: "GET",
									}).then(function (t) {
										t.text().then(function (t) {
