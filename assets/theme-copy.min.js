...
!(function (e) {
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function (e) {
								...
								arguments.length > 1 && void 0 !== arguments[1] && arguments[1] && this.flickityInstance.pausePlayer(), this.flickityInstance.select(e, !1, !t);
							},
						},
						{
							key: "next",
							...
							value: function () {
								...
								(this.flickityInstance = new Flickity(this.element, t)),
									...
									this.options.onClick &&
										this.flickityInstance.on("staticClick", function (t, i, n, a) {
											e.options.onClick(n, a);
										});
							},
						},
						{
						...
						},
						{
							...
							value: function () {
								...
								this.isOpen ||
									...
									a.default.matchesBreakpoint("lap-and-up")
						...
						},
						{
							...
							value: function () {
								this.isOpen &&
									...
									a.default.matchesBreakpoint("lap-and-up") ? document.body.removeEventListener("click", this._clickOutsideListener) : this.showOverlay && (this.pageOverlayElement.classList.remove("is-visible"), this.pageOverlayElement.removeEventListener("click", this._closeListener)),
							...
							value: function () {
								...
								fastdom.measure(function () {
									var o = window.innerHeight,
										...
										l = o / 2;
									if ("bottom" === e.preferredPosition) (a = "right"), (n = e.element.clientHeight <= o - (r.bottom + s) || o - r.bottom >= l ? "bottom" : "top");
									else if ("top" === e.preferredPosition) (a = "right"), (n = e.element.clientHeight <= r.top - s || r.top >= l ? "top" : "bottom");
									else {
										n = "left";
										var c = e.element.clientHeight / 2;
										a = r.top >= c && o - r.bottom >= c ? "center" : o - r.bottom >= c ? "bottom" : "top";
									}
									e.preferredAlignment && (a = e.preferredAlignment),
										"top" === n ? ((t = r.top - e.element.clientHeight - s), (i = "center" === a ? window.innerWidth - r.right - e.element.clientWidth / 2 + 3 : window.innerWidth - r.right)) : "bottom" === n ? ((t = r.bottom + s), (i = "center" === a ? window.innerWidth - r.right - e.element.clientWidth / 2 + 3 : window.innerWidth - r.right)) : ((i = window.innerWidth - r.left + s), (t = "center" === a ? r.top - e.element.clientHeight / 2 + e.activator.clientHeight / 2 : "top" === a ? r.bottom - e.element.clientHeight : r.top));
								}),
				...
				_createClass(e, [
					{
						...
						value: function (e, t) {
							...
							var a = i.querySelector(".ProductItem__Image:not(.ProductItem__Image--alternate)");
				...
				function e(t, i) {
					...
					(this.productData = a.product),
						...
						this.productData.variants.forEach(function (e) {
							e.id === a.selected_variant_id && ((n.currentVariant = e), (n.option1 = e.option1), (n.option2 = e.option2), (n.option3 = e.option3));
						}),
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function (e, t) {
								this._updateProductPrices(t, e), this._updateInventory(t, e), this._updateSku(t, e), this._updateUnitPrice(t, e), this._updateAddToCartButton(t, e), this.storeAvailability.updateWithVariant(t), this._updateShippingCostText(t), this.element.dispatchEvent(new CustomEvent("variant:changed", { bubbles: !0, detail: { variant: t, previousVariant: e } }));
							},
						},
						{
							...
							value: function (e, t) {
								...
								if (e) {
									if (null === i || (t && t.price === e.price && t.compare_at_price === e.compare_at_price)) return;
									if (((i.innerHTML = ""), e.compare_at_price > e.price)) {
										var n = e.compare_at_price - e.price,
											a = window.theme.moneyFormat;
										if (((i.innerHTML += '<span class="ProductMeta__Price Price Price--highlight Text--subdued u-h4" data-money-convertible>' + r.default.formatMoney(e.price, a) + "</span>"), (i.innerHTML += '<span class="compare-ajax ProductMeta__Price Price Price--compareAt Text--subdued u-h4" data-money-convertible>' + r.default.formatMoney(e.compare_at_price, a) + "</span>"), n > 0)) {
											var s = document.createElement("span");
											(s.className = "price-difference ajax"), (s.textContent = "Du sparst " + r.default.formatMoney(n, a)), i.appendChild(s);
										}
									} else i.innerHTML += '<span class="ProductMeta__Price Price Text--subdued u-h4" data-money-convertible>' + r.default.formatMoney(e.price, window.theme.moneyFormat) + "</span>";
									i.style.display = "";
						...
						},
						{
							...
							value: function (e) {
								...
								if (this.options.useAjaxCart) {
									...
									fetch(window.routes.cartAddUrl + ".js", { body: JSON.stringify(s.default.serialize(n)), credentials: "same-origin", method: "POST", headers: { "Content-Type": "application/json", "X-Requested-With": "XMLHttpRequest" } }).then(function (e) {
										document.dispatchEvent(new CustomEvent("theme:loading:end")),
											e.ok
												? (i.removeAttribute("disabled"), t.element.dispatchEvent(new CustomEvent("product:added", { bubbles: !0, detail: { variant: t.currentVariant, quantity: parseInt(n.querySelector('[name="quantity"]').value) } })), dataLayer.push({ event: "optimize:product:added" }))
						...
						value: function () {
							...
							if (n)
								for (var a = 0; a !== this.provinceSelect.options.length; ++a)
									if (this.provinceSelect.options[a].text === n) {
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function (e, t) {
								if (!s.default.matchesBreakpoint("pocket")) {
							...
							value: function (e) {
								return e.map(function (e) {
									var t,
										...
										o = s.default.matchesBreakpoint("phone") ? 1200 : 1800;
			...
			r = (function () {
				function e(t, i) {
					...
					_classCallCheck(this, e),
						...
						(this.isOpen = !1),
						(this.pageOverlayElement = document.querySelector(".PageOverlay")),
						(this.variantChoiceList = s.default.nodeListToArray(this.element.querySelectorAll(".VariantSelector__Choice"))),
						...
						},
						{
							...
							value: function (e) {
								...
								t.classList.add("is-selected"),
									s.default.getSiblings(t, ".is-selected").forEach(function (e) {
										return e.classList.remove("is-selected");
									});
							},
						},
						...
						},
						{
							...
							value: function (e) {
								var t = this,
									...
									a = !1;
								s.default.nodeListToArray(n).forEach(function (e) {
									var t = parseInt(e.parentElement.getAttribute("data-option-position")) - 1,
										n = "";
									i.options.forEach(function (e, i) {
										i !== t && (n += e);
									}),
										e.getAttribute("data-variant-title") === n ? (e.setAttribute("aria-hidden", "false"), (a = !0)) : e.setAttribute("aria-hidden", "true");
								}),
									a || n.children[0].setAttribute("aria-hidden", "false");
								var r = 0;
								s.default.nodeListToArray(this.element.querySelectorAll(".VariantSelector__ChoicePrice")).forEach(function (e, n) {
									var a = parseInt(e.getAttribute("data-color-position")) - 1;
									t.parentProductVariants.productData.variants.forEach(function (t) {
										var s = !0;
										t.options.forEach(function (e, n) {
											n !== a && t.options[n] !== i.options[n] && (s = !1);
										}),
											s && t.options[a] === i.options[a] && r++ === n && (e.innerHTML = '<span class="Heading Text--subdued">' + o.default.formatMoney(t.price, window.theme.moneyFormat) + "</span>");
									});
								});
							},
						},
				...
				function e(t, i, n) {
					switch ((_classCallCheck(this, e), (this.element = t), (this.delegateElement = new domDelegate.Delegate(this.element)), (this.stackProductImages = i), (this.enableVideoLooping = n), (this.player = null), this.element.getAttribute("data-media-type"))) {
						case "video":
							...
							(a.rel = "stylesheet"), (a.href = "https://cdn.shopify.com/shopifycloud/shopify-plyr/v1.0/shopify-plyr.css"), document.head.appendChild(a), window.Shopify.loadFeatures([{ name: "video-ui", version: "1.0", onLoad: this._setupHtml5Video.bind(this) }]);
							break;
						case "external_video":
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								var e = this;
								(this.player = new Shopify.Plyr(this.element.querySelector("video"), { controls: ["play", "progress", "mute", "volume", "play-large", "fullscreen"], loop: { active: this.enableVideoLooping }, hideControlsOnPause: !0, clickToPlay: !0, iconUrl: "//cdn.shopify.com/shopifycloud/shopify-plyr/v1.0/shopify-plyr.svg", tooltips: { controls: !1, seek: !0 } })),
	...
	function (e, t, i) {
		...
		var n = i(7),
			...
			o = (function () {
				function e(t) {
					_classCallCheck(this, e), (this.element = t), (this.delegateElement = new domDelegate.Delegate(this.element)), (this.countrySelector = new s.default(this.element.querySelector('[name="country"]'), this.element.querySelector('[name="province"]'))), this._attachListeners();
				}
				return (
					_createClass(e, [
						{
						...
						},
						{
							...
							value: function () {
								...
								document.dispatchEvent(new CustomEvent("theme:loading:start")),
									fetch(window.routes.cartUrl + "/shipping_rates.json?shipping_address[zip]=" + s + "&shipping_address[country]=" + t + "&shipping_address[province]=" + i, { credentials: "same-origin", method: "GET" }).then(function (t) {
										t.json().then(function (i) {
											document.dispatchEvent(new CustomEvent("theme:loading:end"));
											var s = e.element.querySelector(".ShippingEstimator__Results"),
												o = e.element.querySelector(".ShippingEstimator__Error");
											if (t.ok) {
												var r = i.shipping_rates;
												if (0 === r.length) s.innerHTML = "<p>" + window.languages.shippingEstimatorNoResults + "</p>";
												else {
													var l = "";
													1 === r.length ? (l += "<p>" + window.languages.shippingEstimatorOneResult + "</p><ul>") : (l += "<p>" + window.languages.shippingEstimatorMoreResults.replace("{{count}}", r.length) + "</p><ul>"),
														...
														(l += "</ul>"),
														(s.firstElementChild.innerHTML = l);
												}
												TweenLite.fromTo(s.firstElementChild, 0.6, { autoAlpha: 0, y: -15 }, { autoAlpha: 1, y: 0, delay: 0.35 }), (o.style.display = "none"), (s.style.display = "block"), n.default.slideDown(s);
											} else {
												var c = "";
				...
				_createClass(e, null, [
					{
						...
						value: function (t) {
							function i(e, t) {
								...
								var s = e.substr(0, n),
									o = {};
								return (o[e.substring(n + 1, e.length - 1)] = t), i(s, o);
							}
							for (var n = {}, a = 0, s = t.elements.length; a < s; a++) {
								var o = t.elements[a];
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function (e, t) {
								...
								(n.classList.contains("Collapsible--autoExpand") && s.default.matchesBreakpoint("tablet-and-up")) ||
									("true" === t.getAttribute("aria-expanded") ? this._close(n, t) : this._open(n, t),
									a.default.getSiblings(n).forEach(function (e) {
										return i._close(e);
									}),
									e.preventDefault());
							},
								...
								return (
									...
									fetch(window.routes.rootUrlWithoutSlash + "/variants/" + e + "?section_id=store-availability").then(function (i) {
										return i.text().then(function (i) {
											...
											var a = t.element.querySelector(".store-availabilities-modal__product-title");
											a && (a.textContent = t.productTitle);
											var s = document.getElementById("StoreAvailabilityModal-" + e);
											document.body.appendChild(s), new n.default(s);
										});
									})
								);
							},
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								...
								fastdom.measure(function () {
									(t = window.pageYOffset), (i = s.offsetHeight), (a = parseInt(window.getComputedStyle(document.body).getPropertyValue("--use-sticky-header") || 0)), e.articleNavElement && (n = e.articleNavElement.offsetTop + e.articleNavElement.clientHeight - i);
								}),
									fastdom.mutate(function () {
										(e.toolbarElement.style.top = a ? i + "px" : null), e.articleNavElement ? (t > 150 && e.articleNavElement && t < n ? e.toolbarElement.classList.add("is-visible") : e.toolbarElement.classList.remove("is-visible")) : t > 150 ? e.toolbarElement.classList.add("is-visible") : e.toolbarElement.classList.remove("is-visible");
									});
							},
						},
						{
							...
							var e = this,
								...
								i = setInterval(function () {
									"youtube" === e.options.videoType
										? window.YT && ((e.player = new YT.Player(t, { videoId: e.options.videoId, playerVars: { showinfo: 0, controls: 0, fs: 0, rel: 0, height: "100%", width: "100%", iv_load_policy: 3, html5: 1, loop: 1, playsinline: 1, modestbranding: 1, disablekb: 1, origin: e.options.requestHost }, events: { onReady: e._onYouTubeReady.bind(e), onStateChange: e._onYouTubeStateChange.bind(e) } })), clearInterval(i))
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								(this._onProductAddedListener = this._onProductAdded.bind(this)),
									...
									"page" !== this.options.type ? (this.delegateElement.on("click", '[data-action="update-item-quantity"], [data-action="remove-item"]', this._updateItemQuantity.bind(this)), this.delegateElement.on("change", ".QuantitySelector__CurrentQuantity", this._updateItemQuantity.bind(this))) : this.delegateElement.on("change", ".QuantitySelector__CurrentQuantity", this._reloadPageWithQuantity.bind(this)),
						...
						},
						{
							...
							value: function (e, t) {
								var i = this;
								document.dispatchEvent(new CustomEvent("theme:loading:start")),
									fetch(window.routes.cartUrl + "/add.js", { body: JSON.stringify({ id: t.getAttribute("data-variant-id"), quantity: 1 }), credentials: "same-origin", method: "POST", headers: { "Content-Type": "application/json", "X-Requested-With": "XMLHttpRequest" } }).then(function (e) {
										e.json().then(function (e) {
											(i.itemCount = e.item_count), i._rerenderCart(a), document.dispatchEvent(new CustomEvent("theme:loading:end"));
										});
									}),
									e.preventDefault();
							},
						},
						{
							key: "_updateCartNote",
							value: function (e, t) {
								fetch(window.routes.cartUrl + "/update.js", { body: JSON.stringify({ note: t.value }), credentials: "same-origin", method: "POST", headers: { "Content-Type": "application/json", "X-Requested-With": "XMLHttpRequest" } });
							},
						},
						{
							key: "_toggleCartNote",
						...
						},
						{
							...
							value: function (e, t) {
								...
								var n,
									a = null;
								0 === (n = "INPUT" === t.tagName ? parseInt(Math.max(parseInt(t.value) || 1, 1)) : parseInt(t.getAttribute("data-quantity"))) && (a = t.closest(".CartItemWrapper")),
									fetch(window.routes.cartChangeUrl + ".js", { body: JSON.stringify({ line: t.getAttribute("data-line"), quantity: n }), credentials: "same-origin", method: "POST", headers: { "Content-Type": "application/json", "X-Requested-With": "XMLHttpRequest" } }).then(function (e) {
										e.json().then(function (e) {
											(i.itemCount = e.item_count), i._rerenderCart(a), document.dispatchEvent(new CustomEvent("theme:loading:end"));
										});
									}),
						...
						},
						{
							...
							value: function (e) {
								var t = this;
								const i = document.querySelector(".CartMessage__Steps__Text"),
									n = document.querySelector(".js-cart-drawer-delivery-left-value"),
									a = document.querySelector(".CartMessage__StepsLines__Active");
								i && n && a && (window.cartBarValue && (n.textContent = window.cartBarValue), (i.style.filter = "blur(5px)"));
								const s = $("#sidebar-cart");
								return (
									s.hasClass("Drawer__Footer__DCart-inited") && parseInt(s.attr("data-dcart-calculated")) > 1 && s.addClass("Drawer__Footer-loading"),
									fetch(window.routes.cartUrl + "?view=" + (this.options.drawer && "cart" !== window.theme.pageType ? "drawer" : "ajax") + "&timestamp=" + Date.now(), { credentials: "same-origin", method: "GET" }).then(function (i) {
										...
										dataLayer.push({ event: "experiment:triggered", "exp.event.type": "cart:updated", "exp.cart.itemCount": t.itemCount }), document.dispatchEvent(new CustomEvent("rerenderCart"));
									})
								);
							},
						},
						{
							...
							value: function () {
								var e = this;
								const t = $("#sidebar-cart"),
									i = t.attr("data-gift-item-id"),
									n = t.attr("data-gift-variant-id");
								if ($("body.template-product").length && $('form.ProductForm[data-productid="' + i + '"]').length);
								else {
									let i = t.find('.CartItemWrapper[data-variant-id="' + n + '"][data-free-gift]');
									i.length || (i = t.find('.CartItemWrapper[data-variant-id="' + n + '"]:first')),
										i.length ||
											$.ajax({
												type: "POST",
												url: window.routes.cartUrl + "/add.js",
												data: JSON.stringify({ items: [{ quantity: 1, id: n }] }),
												contentType: "application/json; charset=utf-8",
												dataType: "json",
												success: function (i) {
													t.attr("data-free-gift", !0), e._rerenderCart();
												},
												error: function (e) {},
											});
								}
						...
						},
						{
							...
							value: function () {
								...
								if ($("body.template-product").length && $('form.ProductForm[data-productid="' + i + '"]').length);
									...
									let i = t.find('.CartItemWrapper[data-variant-id="' + n + '"]:not([data-free-gift]):first');
									if (i.length) {
										const n = i.attr("data-index");
										i.hide(),
											$.ajax({
												type: "POST",
												url: window.routes.cartUrl + "/change.js",
												data: JSON.stringify({ line: n, quantity: 0 }),
												contentType: "application/json; charset=utf-8",
												dataType: "json",
												success: function (i) {
													t.removeAttr("data-free-gift"), e._rerenderCart();
												},
												error: function (e) {},
											});
									}
						...
						},
						{
							...
							value: function (e) {
								...
								if (this.options.drawer && "cart" !== window.theme.pageType) {
									...
									n.replaceChild(i.querySelector(".Cart"), this.element.querySelector(".Cart")), (this.element.querySelector(".Drawer__Main").scrollTop = s);
								...
								var o = JSON.parse(i.querySelector('[data-section-type="cart"]').getAttribute("data-section-settings")),
									r = a.default.nodeListToArray(document.querySelectorAll(".Header__CartDot")),
									l = a.default.nodeListToArray(document.querySelectorAll(".Header__CartCount"));
								...
								const c = $("#sidebar-cart");
								if (c.find(".Cart__ItemList").length) {
									const e = c.find(".Drawer__Footer__SubtotalPrice");
									let t = parseFloat(
										e
											.attr("data-price")
											.replace(/\,/, ".")
									...
									const i = c.attr("data-gift-item-id"),
										n = null;
									if (c.find(".CartMessage__StepsLines__Gift").length)
										if ($("body.template-product").length && $('form.ProductForm[data-productid="' + i + '"]').length);
										else if (t > 0) {
											const e = c.find('.CartItemWrapper[data-variant-id="' + n + '"]:not([data-free-gift]):first');
											if (e.length) t -= parseInt(e.attr("data-price") / 100);
											else {
												const e = c.find('.CartItemWrapper[data-variant-id="' + n + '"][data-free-gift]');
												t >= 60 && e.length;
											}
										}
									window.obj.cartSidebarRefresh(!0);
								}
							},
						},
					]),
		...
		var n = i(6),
			...
			c = (function () {
				function e(t) {
					...
					i && (this.sortPopover = new a.default(i, { onValueChanged: this._sortByChanged.bind(this) }));
					var o = document.getElementById("collection-filter-drawer");
					o && (this.filterDrawer = new n.default(o, { onClose: this._removeUncommittedTags.bind(this) })),
						"sidebar" === this.settings.filterPosition && (this.filterInnerSidebarScroller = new l.default(this.element.querySelector(".CollectionInner__Sidebar"))),
						this.element.querySelector(".PageHeader__ImageWrapper") && window.matchMedia("(-moz-touch-enabled: 0), (hover: hover)").matches && (this.parallaxInstance = new Rellax(".PageHeader__ImageWrapper", { speed: -7, center: !1, round: !0 })),
						...
						},
						{
							...
							value: function (e, t) {
								var i = this,
									...
									s = this.collectionInnerElement.querySelector(".ProductList");
								if (s) {
									var r = parseInt(s.getAttribute("data-" + n + "-count"));
									if (r === a) return;
									s.setAttribute("data-" + n + "-count", a),
										o.default.nodeListToArray(s.querySelectorAll(".Grid__Cell")).forEach(function (e) {
											if ("mobile" === n) e.classList.remove("1/" + r + "--phone"), e.classList.add("1/" + a + "--phone");
											else {
												var t = 2 === r ? 2 : 3,
													s = 2 === a ? 2 : 3;
												"drawer" === i.settings.filterPosition ? (e.classList.remove("1/" + r + "--lap-and-up"), e.classList.add("1/" + a + "--lap-and-up")) : (e.classList.remove("1/" + r + "--desk"), e.classList.add("1/" + a + "--desk")), e.classList.remove("1/" + t + "--tablet-and-up"), e.classList.add("1/" + s + "--tablet-and-up");
											}
											window.theme.showElementStaggering && (e.firstElementChild.style.visibility = "hidden");
										}),
										lazySizes.autoSizer.checkElems();
								}
								t.classList.add("is-active"), o.default.getSiblings(t)[0].classList.remove("is-active"), this._setupAnimation(), fetch(window.routes.cartUrl + "/update.js", { body: JSON.stringify({ attributes: _defineProperty({}, "collection_" + n + "_items_per_row", a) }), credentials: "same-origin", method: "POST", headers: { "Content-Type": "application/json", "X-Requested-With": "XMLHttpRequest" } });
							},
						},
						{
							key: "_sortByChanged",
							...
							value: function () {
								...
								if (history.replaceState) {
									var n = this.currentTags.length > 0 ? this.currentTags.join("+") : "",
										a = window.location.protocol + "//" + window.location.host + this.settings.collectionUrl + "/" + n + "?sort_by=" + this.currentSortBy;
			...
			r = (function () {
				function e(t) {
					...
					_classCallCheck(this, e),
						...
						(this.carousels = []),
						s.default.nodeListToArray(this.element.querySelectorAll("[data-flickity-config]")).forEach(function (e) {
								...
								if (!t.classList.contains("is-active")) {
									...
									this.timeline.eventCallback("onReverseComplete", function () {
										n.setAttribute("aria-hidden", "false"),
											s.default.getSiblings(n, '.TabPanel[aria-hidden="false"]').forEach(function (e) {
						...
						},
						{
							...
							value: function () {
								...
								if ((this.intersectionObserver && this.intersectionObserver.disconnect(), (this.timeline = new TimelineLite({ delay: 0.5 })), "grid" === this.options.layout && window.theme.showElementStaggering))
									(this.intersectionObserver = new IntersectionObserver(this._reveal.bind(this))),
										s.default.nodeListToArray(this.element.querySelectorAll('.TabPanel[aria-hidden="false"] .ProductList .ProductItem')).forEach(function (t) {
											e.intersectionObserver.observe(t);
										});
								else {
						...
						},
						{
							...
							value: function (e) {
								...
								if (t && t.featured_image && (!i.featured_image || i.featured_image.id !== t.featured_image.id)) {
									...
									s.style.cssText = "max-width: " + n.width + "px; --aspect-ratio: " + n.width / n.height;
									var o = document.createElement("img");
									o.classList.add("Image--lazyLoad"), o.setAttribute("data-src", a.default.getSizedImageUrl(n.src, "1x1").replace("_1x1.", "_{width}x.")), o.setAttribute("data-widths", "[" + a.default.getSupportedSizes(n, [200, 400, 600, 700, 800, 900, 1e3]).join(",") + "]"), o.setAttribute("data-sizes", "auto"), s.replaceChild(o, s.querySelector("img"));
								}
							},
						},
					]),
		...
		var n = i(3),
			a = (function () {
				function e(t) {
					...
					var a = document.getElementById("footer-currency-popover");
					a && (this.currencyPopover = new n.default(a, { preferredAlignment: "center", preferredPosition: "top", threshold: 12 }));
				}
				return (
					_createClass(e, [
						{
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								...
								e && this.localizationPopovers.push(new s.default(e, { preferredAlignment: "center", preferredPosition: "bottom", threshold: 12 }));
								var t = document.getElementById("header-locale-popover-1");
								t && this.localizationPopovers.push(new s.default(t, { preferredAlignment: "center", preferredPosition: "bottom", threshold: 12 }));
								var i = document.getElementById("header-currency-popover-0");
								i && this.localizationPopovers.push(new s.default(i, { preferredAlignment: "center", preferredPosition: "bottom", threshold: 12 }));
								var a = document.getElementById("header-currency-popover-1");
								a && this.localizationPopovers.push(new s.default(a, { preferredAlignment: "center", preferredPosition: "bottom", threshold: 12 }));
							},
						},
						{
						...
						},
						{
							...
							value: function () {
								...
								fastdom.measure(function () {
									...
									if (i) {
										var a = n.default.outerHeightWithMargin(i.querySelector(".HorizontalList__Item"));
										i.scrollHeight > a && (t = !0);
									}
								}),
							...
							new google.maps.Geocoder().geocode({ address: this.options.mapAddress }, function (t, i) {
								if (i !== google.maps.GeocoderStatus.OK) Shopify.designMode;
									...
									var n = { zoom: e.options.zoom, center: t[0].geometry.location, draggable: !1, clickableIcons: !1, scrollwheel: !1, disableDoubleClickZoom: !0, disableDefaultUI: !0 },
										a = new google.maps.Map(e.element.querySelector(".FeaturedMap__GMap"), n),
										s = a.getCenter();
									a.setCenter(s);
									var o = {
									...
									new google.maps.Marker({ map: a, position: a.getCenter(), icon: o });
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								(this.carousel = new n.default(this.element.querySelector("[data-flickity-config]"))), new a.default(this.element);
							},
						},
					]),
					e
			...
			p = (function () {
				function e(t) {
					...
					c &&
						...
						this.options.stackProductImages && ((this.slideshowNavDots = this.element.querySelector(".Product__SlideshowNav--dots")), (this.slideshowNavDotsItems = this.slideshowNavDots ? d.default.nodeListToArray(this.slideshowNavDots.querySelectorAll("a")) : [])),
						this.options.showThumbnails && ((this.slideshowNavThumbnails = this.element.querySelector(".Product__SlideshowNav--thumbnails")), (this.slideshowNavThumbnailsItems = this.slideshowNavThumbnails ? d.default.nodeListToArray(this.slideshowNavThumbnails.querySelectorAll(".Product__SlideshowNavImage")) : [])),
						...
						},
						{
							...
							value: function (e, t) {
								...
								if (void 0 !== (t = t || this.constructors[n])) {
									var a = Object.assign(new t(e), { id: i, type: n, container: e });
	...
	function (e, t, i) {
		...
		var n = i(2),
			...
			s = (function () {
				function e(t) {
					_classCallCheck(this, e), (this.element = t), (this.carousel = new n.default(this.element.querySelector("[data-flickity-config]"))), new a.default(this.element);
				}
				return (
					_createClass(e, [
						{
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function () {
								var e = this;
								(this.popovers = []),
									s.default.nodeListToArray(this.element.querySelectorAll(".Popover")).forEach(function (t) {
						...
						},
						{
							...
							value: function () {
								var e = this;
								(this.outerCarousel = new n.default(this.element.querySelector(".ShopTheLook"), { onSelect: this._onLookChanged.bind(this) })), (this.innerCarousels = new Array(this.outerCarousel.flickityInstance.cells.length));
								for (var t = 0; t !== this.innerCarousels.length; ++t) this.innerCarousels[t] = [];
								s.default.nodeListToArray(this.element.querySelectorAll(".ShopTheLook__ProductList")).forEach(function (t) {
						...
						},
						{
							...
							value: function (e, t) {
								var i = this.outerCarousel.getSelectedCell(),
									n = null;
								s.default.nodeListToArray(i.querySelectorAll(".ShopTheLook__Dot")).forEach(function (t, i) {
						...
						},
						{
							...
							value: function (e, t) {
								...
								this.popovers.forEach(function (e) {
									...
									this.usePocketMode && !n && this.popovers[a].open();
							},
						},
						{
							key: "_openPocketZoom",
							...
							value: function (e) {
								...
								fastdom.measure(function () {
									var n = window.innerWidth / (i.offsetWidth - 2 * parseInt(window.getComputedStyle(i).paddingLeft)),
										a = Math.round(i.offsetHeight * n),
										s = Math.round(Math.max(a - (window.innerHeight - e.element.offsetHeight), 0)),
										o = a - s,
										r = Math.round(-(i.getBoundingClientRect().top - (a - i.offsetHeight) / 2)),
										l = Math.round(r - s);
									(t._calculateTransformForDotListener = function (e) {
										var i = Math.round((e.detail.dot.offsetTop + e.detail.dot.offsetHeight / 2) * n),
											a = Math.round(i - o / 2),
											s = Math.min(Math.max(r - a, l), r);
										fastdom.mutate(function () {
											t.outerCarousel.flickityInstance.viewport.style.transform = "translate3d(0, " + Math.round(s) + "px, 0) scale(" + n + ")";
										});
									}),
	...
	function (e, t, i) {
		...
		var n = i(2),
			...
			o = (function () {
				function e(t) {
					_classCallCheck(this, e), (this.element = t), (this.delegateElement = new domDelegate.Delegate(this.element)), (this.slideshow = new n.default(this.element.querySelector("[data-flickity-config]"), { onSelect: this._onSlideChanged.bind(this) })), (this.selectedSlide = null), (this.shouldAnimate = !0), (this.timeline = new TimelineLite({ delay: window.theme.showPageTransition ? 0.5 : 0 })), this.slideshow.flickityInstance.cells.length > 0 && this._transitionToSlide(this.slideshow.flickityInstance.selectedCell.element, !0), this._attachListeners();
				}
				return (
					_createClass(e, [
						{
						...
						},
						{
							...
							value: function (e) {
								...
								this.timeline.clear(),
									...
									a.default.nodeListToArray(e.querySelectorAll(".Slideshow__Image")).forEach(function (i) {
						...
						},
						{
							...
							value: function (e) {
								...
								this.timeline.fromTo(e, this.shouldAnimate ? 0.3 : 0, { autoAlpha: 1 }, { autoAlpha: 0, ease: Cubic.easeInOut, delay: this.shouldAnimate ? 0.35 : 0 }), t && this.timeline.fromTo(t, this.shouldAnimate ? 0.4 : 0, { autoAlpha: 1, y: 0 }, { autoAlpha: 0, y: 20, ease: Cubic.easeIn }, 0), i && this.timeline.fromTo(i, this.shouldAnimate ? 0.4 : 0, { autoAlpha: 1, y: 0 }, { autoAlpha: 0, y: 10, ease: Cubic.easeIn }, 0);
							},
						},
						{
							key: "_slideEnter",
							value: function (e) {
								...
								this.slideshow.flickityInstance.options.autoPlay && "paused" === this.slideshow.flickityInstance.player.state && this.slideshow.flickityInstance.unpausePlayer(),
									window.CSS && window.CSS.supports("(object-fit: cover) or (-o-object-fit: cover)") && (window.theme.showImageZooming ? this.timeline.fromTo(t, this.shouldAnimate ? 1.2 : 0, { opacity: 0, scale: 1.2 }, { opacity: 1, scale: 1, ease: Quad.easeOut }, "enter") : this.timeline.fromTo(t, this.shouldAnimate ? 1.2 : 0, { opacity: 0 }, { opacity: 1, ease: Quad.easeOut }, "enter")),
						...
						},
						{
							...
							value: function () {
								var e = this.slideshow.flickityInstance.selectedIndex,
									t = s.default.getCurrentBreakpoint();
								if (this.slideshow.flickityInstance.cells.length - 1 > e) {
									var i = this.slideshow.flickityInstance.cells[e + 1].element,
										n = a.default.nodeListToArray(i.querySelectorAll(".Slideshow__ImageContainer")),
										o = null;
	...
	function (e, t, i) {
		...
		var n = i(2),
			...
			s = (function () {
				function e(t) {
					_classCallCheck(this, e), (this.element = t), (this.delegateElement = new domDelegate.Delegate(this.element)), (this.navItems = a.default.nodeListToArray(this.element.querySelectorAll(".TestimonialNav__Item"))), (this.carousel = new n.default(this.element.querySelector(".TestimonialList"), { onSelect: this._testimonialChanged.bind(this) })), this._attachListeners();
				}
				return (
					_createClass(e, [
						{
								...
								if (!i.classList.contains("is-selected")) {
									...
									fastdom.measure(function () {
										...
										if ((a = i < e)) {
											var n,
												r = t.offsetLeft,
												l = (n = r <= i - (r + t.offsetWidth) ? t.previousElementSibling || t : t.nextElementSibling || t).offsetLeft - s.scrollLeft,
												c = l + n.offsetWidth;
											c > i ? (o = c - i) : l < 0 && (o = l);
										}
									}),
										fastdom.mutate(function () {
											a && s.scrollBy({ behavior: "smooth", left: o }),
												t.classList.add("is-selected"),
	...
	function (e, t, i) {
		...
		var n = i(21),
			...
			s = i(57);
		!(function () {
			new n.Collapsible(), new n.Modal(), new a.ResponsiveHelper(), "password" !== window.theme.pageType && "gift_card" !== window.theme.pageType && new n.LoadingBar();
			var e,
				t,
				i,
				o,
				r,
				l,
				c = new s.SectionContainer();
			c.register("header", s.HeaderSection),
				c.register("footer", s.FooterSection),
				c.register("sidebar-menu", s.SidebarMenuSection),
				c.register("cart", s.CartSection),
				c.register("newsletter-popup", s.NewsletterPopupSection),
				c.register("slideshow", s.SlideshowSection),
				c.register("collection-list", s.CollectionListSection),
				c.register("article-list", s.ArticleListSection),
				c.register("featured-product", s.FeaturedProductSection),
				c.register("image-with-text-block", s.ImageWithTextBlockSection),
				c.register("timeline", s.TimelineSection),
				c.register("map", s.MapSection),
				c.register("featured-collections", s.FeaturedCollectionsSection),
				c.register("shop-the-look", s.ShopTheLookSection),
				c.register("testimonials", s.TestimonialsSection),
				c.register("background-video", s.BackgroundVideoSection),
				c.register("product", s.ProductSection),
				c.register("product-recommendations", s.ProductRecommendationsSection),
				c.register("collection", s.CollectionSection),
				c.register("article-list", s.ArticleListSection),
				c.register("article", s.ArticleSection),
				c.register("faq", s.FaqSection),
				c.register("login", s.LoginSection),
				c.register("addresses", s.AddressesSection),
				c.register("gift-card", s.GiftCardSection),
				c.register("search", s.SearchSection),
				c.register("recently-viewed-products", s.RecentlyViewedProductsSection),
				c.register("shop-now", s.ShopNowSection),
				...
				i.on("click", '[href^="#"], [data-href]', function (e, t) {
					...
					if ("#" !== i && "#main" !== i) {
						...
						if ((o && (a -= o.clientHeight), t.hasAttribute("data-focus-on-click"))) {
							var s = window.pageYOffset;
							n.focus({ preventScroll: !0 }), window.pageYOffset !== s && window.scrollTo(window.pageXOffset, s), n.focus();
						}
						window.scrollTo({ behavior: "smooth", top: n.offsetTop - a }), e.preventDefault();
					}
				}),
				(r = window.innerWidth),
