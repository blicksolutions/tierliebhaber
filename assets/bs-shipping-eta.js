...
const insertContent = (hours, minutes, deliveryDate) => {
	const hoursSpan = document.querySelector(".bs-shipping-eta__hours");
	const minutesSpan = document.querySelector(".bs-shipping-eta__minutes");
	const deliveryDateSpan = document.querySelector(".bs-shipping-eta__delivery-date");
